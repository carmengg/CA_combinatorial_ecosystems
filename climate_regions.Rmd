...
###################################################################
tic("pre-regions")
pre_regions <- pre_temp_regions(bis_clim_2001)
toc()
plot(pre_regions)
plot(pre_regions==1)
###################################################################
regions <- separate_polar_boreal(pre_regions,avg_per_month)
plot(regions==1)
plot(regions<=2)
plot(regions<=3)
plot(regions<=4)
...
temp_regions <- function(temp_map, months_weather){
  avg_per_month <- stack()
  n = nlayers(months_weather)/12  # assumes you have data for each month in year
...
#plot(temp_regions(bis_clim_2001,months_clim_2001))
```
